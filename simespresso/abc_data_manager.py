...
class ABCDataManager(object):
    ...
    class manages data existing in qe and allows this data to be
    queried and to be changed.
    The queries and changes to particles
    occur through the abstract methods in this class.  See subclasses
