...
def ReadEspressoOutputFile(file_name):
    '''
    This class parses  Espresso output files which usually will have a name like 'name.charge'.
    ...
    About the second line, the first number is the type of Bravais lattice,
    and the three following numbers are the celldm defined in the input file of pw.x.
    These are just details but actually the first lines don't interest us because what we want is the charge density,
    which is defined for each point of the grid starting line 34.
    ...
    with open(file_name, 'r') as f:
        ...
        try:
                ...
                logging.debug('floats:'+str(floats))
